/* ---- Pagina Menù: carica categorie e apre la lista prodotti della categoria scelta ---- */
...
class MenuPage extends StatelessWidget {
  ...
  /* ---- Mappa il titolo visuale alla chiave categoria usata nei dati ---- */
  ...
  /* ---- Naviga alla pagina lista prodotti della categoria selezionata ---- */
  ...
  Widget build(BuildContext context) {
    /* ---- Carico l’elenco categorie dal repository asincrono ---- */
    final repo = MenuCategoriesRepo.load();

    return Scaffold(
      body: Padding(
        padding: const EdgeInsets.all(16),
        /* ---- FutureBuilder: gestisce loading/errore/dati e costruisce la lista ---- */
        child: FutureBuilder<List<MenuCategory>>(
          ...
          builder: (context, snap) {
            ...
            /* ---- Lista verticale con spaziatura: ogni elemento è una CategoryCard tappabile ---- */
